"""
LEGACY migration system — preserved for reference only.

This file was the original custom migration system used before Alembic
was introduced in ConfigFoundry v0.5.  It is no longer called by any
production code.

The active migration system is now:
    core/migrations/runner.py  — calls Alembic
