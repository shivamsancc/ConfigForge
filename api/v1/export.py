"""
API v1 router for /api/v1/export.

Endpoints
---------
GET /api/v1/export/devices.xlsx    → binary xlsx
GET /api/v1/export/bandwidth.xlsx  → binary xlsx
GET /api/v1/export/subnets.xlsx    → binary xlsx
"""
